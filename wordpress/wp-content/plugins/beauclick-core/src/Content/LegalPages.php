	...
	private static function privacy_content(): string {
		return self::blocks(
			[
				...
				[ 'p', 'می‌توانید اطلاعات آدرس و صورتحساب خود را از بخش «حساب کاربری» ویرایش کنید. برای درخواست‌های مربوط به حذف یا دریافت اطلاعات، از طریق صفحه «تماس با ما» با ما در ارتباط باشید.' ],
			]
		);
	}
