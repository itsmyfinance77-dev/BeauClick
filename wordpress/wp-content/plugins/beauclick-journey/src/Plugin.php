...
use BeauClick\Journey\Database\Migrations\CreateJourneyTables;
use BeauClick\Journey\Rest\JourneyController;

final class Plugin {

	private const GROUP = 'beauclick-journey';
	...
	private function migrations(): array {
		return [ new CreateJourneyTables() ];
	}
	...
	public function register_rest_routes(): void {
		( new JourneyController() )->register_routes();
	}
