...
const nextConfig = {
  ...
  transpilePackages: ['@beauclick/ai-contract', '@beauclick/chat-contract', '@beauclick/design-tokens', '@beauclick/persian-utils', '@beauclick/payment-contract', '@beauclick/referral-contract', '@beauclick/wishlist-contract'],
  eslint: {
