 ...
 * conversion implementation the whole app uses; no feature should hand-roll
 * its own Jalali arithmetic.
 *
 * Ported verbatim from BeauClick V2 (app/src/lib/jalali.ts) per
 * V3_MIGRATION_MATRIX.md's DIRECT REUSE classification — zero logic changes.
 *
 ...
 * Verified in jalali.spec.ts against the well-known 1979-02-11 <->
