...
export const CAPABILITIES_BY_ROLE: Record<Role, string[]> = {
  customer: ['bc_book_service', 'bc_use_ai_assistant'],
  professional: ['bc_manage_own_profile', 'bc_manage_own_services', 'bc_view_own_bookings'],
  business: ['bc_manage_own_profile', 'bc_manage_own_services', 'bc_view_own_bookings', 'bc_manage_business_staff'],
