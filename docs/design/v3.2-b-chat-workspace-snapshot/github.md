...
commit: d2e11ea0f0f760c850997182f900748923e7418b (V3.2-B chat implementation milestone, CI run 33314468705, all green). Repository master separately at 63f9a8b9e76e5eb73faec8e3933c413a0f6fba56 (adds only the PR workflow — no chat code there).
