...
| V3.3 dashboard pack (#45) | this commit | 2026-09-25 | Sibling pack `v3.3-dashboard-pack/`, not a workspace copy; canonical snapshot and gap pack untouched; audited against `2e3da4a` |
