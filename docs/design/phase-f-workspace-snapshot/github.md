...
date: 2026-08-29T22:40:00Z
commit: 0bb226377ed1fe4ddb2e880632c79295ce4ca13e (CI run 33229069474, green)

### Phase F design sync — payment result only (this pass, design workspace only — no repo write)
...
| docs/design/screens/16_CHECKOUT_RESULT.md (rewritten) | v3/apps/web/app/checkout/result/page.tsx, components/ui.tsx, services/payment/src/payment-failure.ts, apps/api/src/checkout/checkout.controller.ts |
| Prototype - Customer §16 نتیجه پرداخت (rewritten) | same as above |
