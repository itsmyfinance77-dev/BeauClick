...
| Fast suite (unit + pg-mem) | ✅ **275 passing** |
| Real-PostgreSQL + OpenSearch | ✅ **318 passing**, 14/14 suites |
| **Total** | ✅ **593 passing, 0 failing** |
| Build | ✅ `api` + `web` |
| Migrations zero → re-run | ✅ apply, verify, idempotent skip |

Real-database coverage added this phase: search projection 29, notifications 28, journey 27, auth cookie 21, analytics 22, loyalty 19, OpenSearch 33.
